            ...
            <>
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 
    flex items-center justify-center border-2 border-white/20 shadow-lg overflow-hidden">
                    ...
                    {formData.profilePhotoUrl ? (
                      ...
                      <span className="text-3xl font-bold bg-gradient-to-br from-cyan-400 to-blue-400 
