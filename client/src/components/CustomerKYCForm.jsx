    ...
    <div>
      ...
      <div className="border-2 border-dashed border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 text-center hover:border-cyan-400/50 hover:bg-white/5 transition-all duration-300">
        ...
        <p className="text-gray-300 mb-2 sm:mb-3 text-base sm:text-lg">
          {field === 'profile_photo_url' ? 'Upload your profile photo' : 'Upload supporting documents (ID, Address proof, etc.)'}
        </p>
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">
            Customer <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">KYC</span> Verification
          </h1>
          <p className="text-lg sm:text-xl text-gray-300">Complete your verification to access all features</p>
        </div>
            ...
            <CardContent className="space-y-6 sm:space-y-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  />
                  {errors.customer_name && <p className="text-red-400 text-sm mt-1 flex items-center gap-2">
                    <AlertCircle className="w-4 h-4" />
                ...
                <div>
                  ...
                  />
                  {errors.customer_email && <p className="text-red-400 text-sm mt-1 flex items-center gap-2">
                    <AlertCircle className="w-4 h-4" />
                ...
                <div>
                  ...
                  />
                  {errors.customer_phone && <p className="text-red-400 text-sm mt-1 flex items-center gap-2">
                    <AlertCircle className="w-4 h-4" />
                ...
                <div className="sm:col-span-2">
                  <Label className="text-white/90 font-medium text-lg">Address *</Label>
                  <Input 
                    type="text" 
                  ...
                  />
                  {errors.customer_address && <p className="text-red-400 text-sm mt-1 flex items-center gap-2">
                    <AlertCircle className="w-4 h-4" />
        ...
        {currentStep === 3 && (
          <Card className={cardClass}>
            ...
            <CardContent className="space-y-6 sm:space-y-8">
              <div className="bg-gradient-to-r from-blue-500/10 via-cyan-500/10 to-teal-500/10 border border-blue-500/20 rounded-2xl p-6 mb-6">
                <div className="flex items-center gap-3 mb-3">
                  <Shield className="w-6 h-6 text-blue-400" />
                  <h3 className="font-medium text-blue-400 text-xl">Required Documents</h3>
                </div>
                <ul className="text-blue-200 space-y-2 text-base">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-lg">
                  {[
                    ...
                    { label: 'Address', value: formData.customer_address, span: 'md:col-span-2' }
                  ].map((item, index) => (
