      ...
      <div className="space-y-6 px-3 xs:px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16">
        ...
        <Card className="glass shine hover:border-blue-400/50 transition-all duration-300">
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <Button 
                className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 hover:shadow-xl transition-all duration-300 px-6 py-3 text-base font-semibold rounded-xl hover:scale-[1.02] active:scale-[0.98] shadow-lg"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-2">
          {stats.map((stat, index) => (
            <Card key={index} className="glass shine group hover:scale-[1.02] transition-all duration-300 hover:shadow-xl">
              <CardContent className="p-6">
