        ...
        <Card className="glass shine hover:border-blue-400/50 transition-all duration-300">
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-xl bg-gradient-to-r from-red-500/20 to-red-500/20 border border-red-500/30 group-hover:from-red-500/30 group-hover:to-red-500/30 transition-all duration-300 shadow-lg">
                <AlertCircle className="w-6 h-6 text-red-700 group-hover:text-red-600 transition-colors duration-300 animate-pulse" />
              </div>
              ...
              <Button
                className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 hover:shadow-xl hover:shadow-red-500/30 transition-all duration-300"
                          ...
                          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                            <div className="space-y-2">
                              <div className="flex items-center gap-3">
                                ...
                                <span className={`px-2 py-1 rounded-full text-xs font-medium ${request.status === 'pending' ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30' :
